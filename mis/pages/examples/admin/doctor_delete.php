              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered">
                    ...
                    <?php
                    $result  = $mysqli->query('select did, fname, lname, gender, qualification, cname from doctor_details inner join doctor_category on doctor_details.cid = doctor_category.cid where available = 1');
                    if ($result) {
