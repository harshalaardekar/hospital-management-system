              ...
              <div class="box">
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $result  = $mysqli->query('select * from room_details left outer join ward_type_details on room_details.wid = ward_type_details.wid left outer join room_type_details on room_details.rid = room_type_details.rid left outer join room_service_type on room_details.rsid = room_service_type.rsid where quantity > 0;');
                      if ($result) {
                      while ($object = $result->fetch_object()) {
                      echo "<tr>
                        <td>".$object->rmno."</td>
                        <td>".$object->floorno."</td>
                        <td>".$object->wname."</td>
                        <td>".$object->rname."</td>
                        <td>".$object->rsname."</td>
                        <td>".$object->quantity."</td>
                        <td> <a href='patient_select.php?rm=".$object->rm."'>Admit</a>
                      </tr>";
                      }
                      }
                      else {
