...
session_start();
$lid = $_SESSION['lid'];
if ($result = $mysqli->query("SELECT pid,fname,lname,dob, height, weight, TIMESTAMPDIFF(YEAR, dob, CURDATE()) AS age, gender,address FROM patient_details WHERE lid='".$lid."'")) {
...
<header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
          ...
          <?php
          if ($result = $mysqli->query("SELECT * FROM appointment WHERE pid =".$pid." AND seen = 0")) {
            ...
            <li class="dropdown notifications-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  ...
                  <ul class="menu">
                    <?php
                    if ($result = $mysqli->query("SELECT dt,time,booking FROM appointment WHERE pid =".$pid." AND seen = 0")) {
                      while ($object = $result->fetch_object()) {
                        $dt = $object->dt;
                        ...
                        echo '
                        <li class="schedule" value="'.$pid.'" style="padding : 1em;">
