    ...
    <div class="wrapper">
      ...
      <section class="invoice">
          ...
          <div class="row invoice-info">
            ...
            session_start();
            $id = $_SESSION['id'];
            if ($result = $mysqli->query("SELECT pid,fname,lname,dob, TIMESTAMPDIFF(YEAR, dob, CURDATE()) AS age, gender,address,initial_problem FROM patient_details WHERE id='".$id."'")) {
              while ($object = $result->fetch_object()) {
                ...
                $pid = $object->pid;
                $initial_problem = $object->initial_problem;
                if ($object->gender == 1) {
                  $gender = 'Male';
                }
                else{
          ...
          <div class="row">
            <div class="col-md-6 col-xs-12">
              <div class="header">
                <h4 class="box-title" style="color: #21618C;">Glomerular Filtration Rate(GFR): <?php echo $gfr; ?></h4>
              </div>
              <div class="demo">
