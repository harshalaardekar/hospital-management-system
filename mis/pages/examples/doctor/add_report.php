...
error_reporting(0);
session_start();
$result = $mysqli->query('select * from doctor_details where lid = '.$_SESSION['lid']);
if ($result) {
          ...
          <div class="row">
            <div class="col-md-12 col-xs-12">
              <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <form id="my-form" enctype="multipart/form-data" action = "patient_add_report_process.php" method = "post">
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" name="dname" id="dname" class="form-control" value="<?php echo $name; ?>" readonly>    
                    </div>
                    <div class="form-group col-md-12">
