                ...
                <div class="box-body">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <input type="text" name="qualification" id="qualification" value="<?php echo $qualification; ?>" class="form-control" readonly>    
                    </div>

                    <div class="form-group col-md-12">
                      <label>YOE:</label>
                      <input type="text" name="yoe" id="yoe" value="<?php echo $yoe; ?>" class="form-control" readonly>    
                    </div>
                    
                    <div class="form-group col-md-12">
                      <label>Category:</label>
                      <?php 
if ($result = $mysqli->query('select cname from doctor_category where cid = '.$cid)) {
  while ($object = $result->fetch_object()) {
    $cname = $object->cname;
  }
}
                      ?>
                      <input type="text" name="category" id="category" value="<?php echo $cname; ?>" class="form-control" readonly>    
                    </div>
                <!-- /.form group -->
                  </div>
                    </div>
