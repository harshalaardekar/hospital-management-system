...
<html>
  <head>
    ...
    <title>Add Doctor | HealthEase</title>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-xs-12   col-md-offset-3">
              ...
              <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" method="post" action="doctor_add_process.php">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                    <input type="number" name="yoe" id="yoe" class="form-control" placeholder="Year of Exp">
                    </div>
                    <div class="form-group">
                    ...
                    <select class="form-control" name="category" id="category">
                        ...
                        <?php
                          $result = $mysqli->query('select * from doctor_category');
                          if ($result) {
                             while ($object = $result->fetch_object()){
                              echo '<option   value="'.$object->cid.'">'.$object->cname.'</option>';
                             }
                          }
                        ?>
                      </select>
