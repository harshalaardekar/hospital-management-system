              ...
              <div class="box">
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php
                      $result  = $mysqli->query('select * from admit left outer join patient_details on admit.pid = patient_details.pid left outer join doctor_details on admit.did = doctor_details.did left outer join room_details on admit.rm = room_details.rm;');
                      if ($result) {
                      ...
                      echo "<tr>
                        ...
                        <td> <a href='#?rm=".$object->adid."'>Discharge</a>
                      </tr>";
                      }
                      }
                      else {
